 ...
 */
@Dependent
public class ReducedGraphGVSGenerator extends GraphGenerator  {
    ...
    public GraphResult generateGraphResult(TraversalGraph graph) {
        String graphvizSource = graphvizUtils.generateSource(graph, true);
	...
	return new ReducedGraphGVSource(graphvizSource);
    }
