 ...
 * kind of {@link org.presentation.model.logging.Message} or other similar
 * object. Specific implementation is used for conversion between the
 * hierarchical object tree of these elements to classes with linear instance
 * fields which are used especially for persisting into database.
 *
 * @author radio.koza
...
public interface MessageMapper {
     ...
     * the {@link java.lang.IllegalArgumentException} will be thrown by the
     * specific implementation of {@link org.presentation.model.logging.Message}
     */
    void setPriority(Integer priority);

    /**
     * Retrieve message string from the message mapped class. Method is used to
     * reconstruct instance of {@link org.presentation.model.logging.Message}
     * implementation from the mapped class.
     *
     ...
     * the {@link org.presentation.model.logging.Message} object implementation
     * and it must be possible to instantiate the message implementing object by
     * use of java reflection feature.
     *
     * @param discriminator String of fully represented class name of the
     * specific implementation of the
     * {@link org.presentation.model.logging.Message}; it is created by calling {@link Class#getName()
