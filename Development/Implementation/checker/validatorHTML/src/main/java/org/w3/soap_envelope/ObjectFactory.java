 ...
 * generated in the org.w3.soap_envelope package. 
...
public class ObjectFactory {
    ...
    private final static QName _Header_QNAME = new QName("http://www.w3.org/soap-envelope", "Header");
    private final static QName _NotUnderstood_QNAME = new QName("http://www.w3.org/soap-envelope", "NotUnderstood");
    private final static QName _Body_QNAME = new QName("http://www.w3.org/soap-envelope", "Body");
    private final static QName _Upgrade_QNAME = new QName("http://www.w3.org/soap-envelope", "Upgrade");
    private final static QName _Envelope_QNAME = new QName("http://www.w3.org/soap-envelope", "Envelope");
    private final static QName _Fault_QNAME = new QName("http://www.w3.org/soap-envelope", "Fault");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: org.w3.soap_envelope
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/soap-envelope", name = "Header")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/soap-envelope", name = "NotUnderstood")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/soap-envelope", name = "Body")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/soap-envelope", name = "Upgrade")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/soap-envelope", name = "Envelope")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://www.w3.org/soap-envelope", name = "Fault")
